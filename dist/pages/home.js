...
(() => {
  ...
  // src/js/animations/footerOverlap.ts
  ...
  // src/js/animations/heroAnimations.ts
  ...
  var _SplitText = class _SplitText2 {
    ...
    static register(core) {
      ...
      if (gsap5) {
        ...
        _context4 = gsap5.core.context || _context4;
      }
  ...
  // src/js/animations/introAnimations.ts
  gsapWithCSS.registerPlugin(CustomEase);
  CustomEase.create("easeMain", "0.625,0.05,0,1");
  ...
  function introCard() {
    ...
    [
      ...
      line2.parentNode?.insertBefore(wrapper, line2);
  ...
  // src/js/animations/scrollFadeIn.ts
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  ...
  // src/js/animations/sliderIntoView.ts
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function sliderIntoView() {
  ...
  // src/js/animations/sliderIntoViewSmooth.ts
  gsapWithCSS.registerPlugin(ScrollTrigger2, CustomEase);
  CustomEase.create("easeMainReverse", "0.55, 0.02, 0.10, 1");
  function sliderIntoViewSmooth() {
  ...
  // src/js/animations/videoParallax.ts
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  ...
  // src/js/components/categorySlider.ts
  function categorySlider(selector3) {
    const sliders = document.querySelectorAll(selector3);
  ...
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function countUp(element, targetValue, duration = 1e3) {
    let startTime = null;
    const startValue = 0;
